...
export const mainAvenues: Avenue[] = [
  {
    ...
    directors: [
      { name: "Rtr. Dhyaani Shah", role: "Community Service", photo: "/members/avatars/dhyaani-shah.webp" },
      { name: "Rtr. Palak Deora", role: "Community Service", photo: "/members/avatars/palak-deora.webp" },
    ],
  },
  {
    slug: "club-service",
    ...
    directors: [
      { name: "Rtr. Naqiya Paisawala", role: "Events and Fellowship", photo: "/members/avatars/naqiya-paisawala.webp" },
      { name: "Rtr. Saloni Kapadia", role: "Events and Fellowship", photo: "/members/avatars/saloni-kapadia.webp" },
    ],
  },
  {
    ...
    directors: [
      { name: "Rtr. Naqiya Paisawala", role: "International Service", photo: "/members/avatars/naqiya-paisawala.webp" },
    ],
  },
  {
    ...
    directors: [
      { name: "Rtr. Ansh Manjul", role: "Professional Development", photo: "/members/avatars/ansh.webp" },
      { name: "Rtr. Meit Bhattad", role: "Professional Development", photo: "/members/avatars/meit-bhattad.webp" },
    ],
  },
];
...
export const supportAvenues: Avenue[] = [
  {
    ...
    directors: [
      { name: "Rtr. Tanisha Kadulkar", role: "Partners in Service", photo: "/members/avatars/tanisha-kadulkar.webp" },
    ],
  },
  {
    slug: "editorials",
    ...
    directors: [
      { name: "Rtr. Shelly Rai", role: "Editorials", photo: "/members/avatars/shelly-rai.webp" },
      { name: "Rtr. Aindree Tiwari", role: "Editorials", photo: "/members/avatars/aindree-tiwari.webp" },
    ],
  },
  {
    slug: "smdc",
    ...
    directors: [
      { name: "Rtr. Ashish Soni", role: "Social Media", photo: "/members/avatars/ashish-soni.webp" },
      { name: "Rtr. Siddhesh Nandoskar", role: "Social Media", photo: "/members/avatars/siddhesh-nandoskar.webp" },
      { name: "Rtr. Bhavika Jain", role: "Social Media", photo: "/members/avatars/bhavika-jain.webp" },
    ],
  },
  {
    slug: "pr-marketing",
    ...
    directors: [
      { name: "Rtr. Meit Bhattad", role: "Public Relations & Marketing", photo: "/members/avatars/meit-bhattad.webp" },
    ],
  },
  {
    slug: "sports",
    ...
    directors: [
      { name: "Rtr. Jiyan Shah", role: "Sports", photo: "/members/avatars/jiyan-shah.webp" },
      { name: "Rtr. Ved Masurkar", role: "Sports", photo: "/members/avatars/ved.webp" },
    ],
  },
  {
    ...
    directors: [
      { name: "Rtr. Ansh Manjul", role: "Entrepreneurship Development", photo: "/members/avatars/ansh.webp" },
      { name: "Rtr. Meit Bhattad", role: "Entrepreneurship Development", photo: "/members/avatars/meit-bhattad.webp" },
    ],
  },
];
